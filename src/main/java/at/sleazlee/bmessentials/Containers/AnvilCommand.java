...
public class AnvilCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("bm.containers.anvil")) {

            if(player.hasPermission("ranks.blockminer")) {
                sender.sendMessage("&4&lBM &cYou need to be at least rank &b&l[10]&c to use this ability!&f Check you &b/ranks&f.");
        ...
        player.openAnvil(location, true); // Open anvil GUI
