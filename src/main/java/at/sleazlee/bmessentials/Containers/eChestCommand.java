...
public class eChestCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (!player.hasPermission("bm.containers.enderchest")) {

            if(player.hasPermission("ranks.blockminer")) {
                sender.sendMessage("&4&lBM &cYou need to be at least rank &b&l[2]&c to use this ability!&f Check you &b/ranks&f.");

            } else if (player.hasPermission("ranks.super")) {
                sender.sendMessage("&4&lBM &cYou need to be at least rank &b&l[2]&c to use this ability!&f Check you &b/ranks&f.");

            } else if (player.hasPermission("ranks.ultra")) {
                sender.sendMessage("&4&lBM &cYou need to be at least rank &b&l[3]&c to use this ability!&f Check you &b/ranks&f.");

            } else if (player.hasPermission("ranks.premium")) {
                sender.sendMessage("&4&lBM &cYou need to be at least rank &b&l[3]&c to use this ability!&f Check you &b/ranks&f.");

            } else if (player.hasPermission("ranks.plus")) {
                sender.sendMessage("&4&lBM &cYou need to be at least rank &b&l[4]&c to use this ability!&f Check you &b/ranks&f.");
